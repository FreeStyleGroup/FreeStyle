      ...
      <section className="max-w-[1320px] mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div className="text-ink-700 text-[15.5px] leading-relaxed space-y-4">
            <p>
              Мы собрали лучший на российском рынке travel-стек — Aviasales, Hotellook, Tutu, Cherehapa, Sletat — в одном
              интерфейсе. Один аккаунт, одна корзина, один профиль путешественника.
            </p>
            <p>
