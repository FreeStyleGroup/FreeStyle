...
import { Train, ArrowRight, Clock, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-surface-1">
      <div className="bg-white border-b border-ink-100">
        <div className="max-w-[1100px] mx-auto px-4 md:px-8 py-5">
          ...
          <div className="text-ink-500 text-sm mb-4">{fmtDateRu(date)} · {pax} пасс.</div>
          <details className="group">
            ...
            <div className="mt-4 bg-surface-1 rounded-2xl p-4 border border-ink-100">
              <RailSearchForm initial={{ from, to, date, pax }} />
            </div>
          </details>
        </div>
      </div>

      <div className="max-w-[1100px] mx-auto px-4 md:px-8 py-6 space-y-4">
        {trains.map((t) => (
